            ...
            with st.spinner("🔄 Analyzing image... Please wait."):
                try:
                    with tempfile.NamedTemporaryFile(suffix=".png", delete=True) as temp_file:
                        ...
                        diagnostic_response = diagnostic_agent.run(diagnostic_query, image_response).content
                        research_response = research_agent.run(research_query, image_response).content
                        patient_response = patient_agent.run(patient_query, image_response).content
